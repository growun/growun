    ...
    public function edit_save_goodsOp() {
        ...
        if (is_array ( $_POST ['spec'] )) {
            foreach ($_POST['spec'] as $value) {
                ...
                if (!empty($goods_info)) {
                    ...
                    $value_keys = array_keys($value['sp_value']);
                        ...
                        $update['date']              = strtotime($date_key.' 12:00:00');
                    // 虚拟商品不能有赠品
		    ...
		    // 生成商品二维码
                    ...
                    $value_keys = array_keys($value['sp_value']);
                        $date_key = $value_keys[0];
                        $insert['date']              = strtotime($date_key.' 12:00:00');
            ...
            if (!empty($goods_info)) {
                ...
                $value_keys = array_keys($value['sp_value']);
                        $date_key = $value_keys[0];
                        $update['date'] = strtotime($value['sp_value'][$date_key].' 12:00:00');
		 ...
		 // 生成商品二维码
                ...
                $value_keys = array_keys($value['sp_value']);
                        $date_key = $value_keys[0];
                        $insert['date'] = strtotime($value['sp_value'][$date_key].' 12:00:00');
