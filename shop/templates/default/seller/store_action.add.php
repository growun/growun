...
<form id="spec_form" name="spec_form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?act=store_spec&op=save_action">
  ...
  <input id="goods_common_id" name="goods_common_id" type="hidden" value="<?php echo $output['goods_common_id']; ?>" />
  <input id="goods_id" name="goods_id" type="hidden" value="<?php echo $output['goods_id']; ?>" />
      ...
      <table class="ncsc-default-table">
        ...
        <tfoot>
          <tr>
            ...
            <a href="javascript:void(0);" nctype="submit-btn" class="submit mt20">保存</a>
            </br>
            <a class="submit" href="<?php echo SHOP_SITE_URL.DS;?>index.php?act=store_goods_add&op=add_step_three&commonid=<?php echo $output['goods_common_id'];?>" >
            下一步
            </a>
            </td></tr><tr>
