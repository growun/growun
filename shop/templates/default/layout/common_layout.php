...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    ...
    <!--
    <?php if ( false && C('mobile_isuse') && C('mobile_app')){?>
    ...
    <div id="search" style="padding-left:30px" class="head-search-bar">
	<!--商品和店铺-->
      <ul class="tab">
        <!--
        <li title="请输入您要搜索的商品关键字" act="search" class="current">课程</li>
      ...
      <form class="search-form" method="get" action="<?php echo SHOP_SITE_URL;?>">
        <input type="hidden" value="search" id="search_act" name="act">
         <input placeholder="请输入您要搜索的课程关键字" name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $_GET['keyword'];?>" maxlength="60" x-webkit-speech lang="zh-CN" onwebkitspeechchange="foo()" x-webkit-grammar="builtin:search" />
...
<div class="wrapper_nav">
    <div class="nav">
        ...
        <ul class="nav_left_list">
            <li class="active_nav"><a href="<?php echo urlShop('index', 'index');?>">首页</a></li>    
            <li><a href="<?php echo urlShop('search', 'index');?>&cate_name=童子军游学训练">童子军游学训练</a></li>    
			<li><a href="<?php echo urlShop('search', 'index');?>&cate_name=成长商城" class="link_last">成长盒子</a></li>
			<li><a href="#">成长炸弹</a></li>    
            <li><a href="<?php echo urlShop('article', 'articl', array('ac_id' => 8));?>">父母知道</a></li>     
