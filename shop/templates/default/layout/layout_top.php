...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    ...
    <!--
      ...
      -->
      <dl>
        <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order">我的课程</a><i></i></dt>
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&state_type=state_new">待付款课程 </a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&state_type=state_send">待确认课程</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&state_type=state_noeval">待评价课程</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fglist">课程收藏</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fslist">机构收藏</a></li>
          </ul>
        </dd>
      </dl>
      ...
      <dl>
      <dt>
      <a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" class="store-join-help">机构登录</a>
      </dt>
      </dl>
      <!--
      <dl>
